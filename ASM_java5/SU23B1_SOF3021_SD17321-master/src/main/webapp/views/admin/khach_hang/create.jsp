...
<sf:form method="post" action="${action}" modelAttribute="kh">
    ...
    <DIV>
        <label>Họ</label>
        <sf:input path="ho"/>
        <sf:errors Style="color:red" path="ho"/>
    </DIV>
    <DIV>
        <label>Tên Đệm</label>
        <sf:input path="tenDem"/>
        <sf:errors Style="color:red" path="tenDem"/>
    </DIV>
    <DIV>
        <label>Tên</label>
        <sf:input path="ten"/>
    ...
    <DIV>
        ...
        <sf:errors Style="color:red" path="ngaySinh"/>
    </DIV>
    <DIV>
        <label>Sdt</label>
        <sf:input path="sdt"/>
        <sf:errors Style="color:red" path="sdt"/>
    </DIV>

    <DIV>
        <label>Địa Chỉ</label>
        <sf:input path="diaChi"/>
        <sf:errors Style="color:red" path="diaChi"/>
    </DIV>
    <DIV>
        <label>Thành phố</label>
        <sf:input path="thanhPho"/>
        <sf:errors Style="color:red" path="thanhPho"/>
    </DIV>
    <DIV>
