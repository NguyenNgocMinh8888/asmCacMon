...
public class CuaHangServlet extends HttpServlet {
    ...
    protected void create(
        ...
        request.setAttribute("view", "/views/cua_hang/createCH.jsp");
    ...
    protected void index(
        ...
        request.setAttribute("view", "/views/cua_hang/indexCH.jsp");
        request.getRequestDispatcher("/views/layout.jsp")
                .forward(request, response);
    }
    ...
    protected void store(
        ...
        try {
            CuaHang domainModelCuaHang = new CuaHang();
            BeanUtils.populate(domainModelCuaHang, request.getParameterMap());
            this.chRepo.insert(domainModelCuaHang);
    ...
    protected void update(
        ...
        try {
            String ma = request.getParameter("ma");
            CuaHang domainModelCuaHang = this.chRepo.findByMa(ma);
            BeanUtils.populate(domainModelCuaHang, request.getParameterMap());
            this.chRepo.update(domainModelCuaHang);
        } catch (IllegalAccessException e) {
            e.printStackTrace();
        } catch (InvocationTargetException e) {
            e.printStackTrace();
