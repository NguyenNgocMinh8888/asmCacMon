...
public class QLHoaDon {
    ...
    public QLHoaDon(String ma, String ngay_tao, String ngay_thanh_toan, String ngay_ship, String ngay_nhan, Boolean tinh_trang, String ten_nguoi_nhan, String dia_chi, String sdt) {
        this.ma = ma;
